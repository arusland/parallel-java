...
//        System.out.println(String.format("!!!! myrank: %d, size: %d, nrows: %d, startRow: %d, endRow: %d",
  //              myrank, size, nrows, startRow, endRow));
        ...
        if (myrank == 0) {
            ...
            for (int i = 1; i < size; i++) {
                ...
                rankEndRow = Math.min(rankEndRow, nrows);

                int rowOffset = rankStartRow * c.getNCols();
                int nElements = (rankEndRow - rankStartRow) * c.getNCols();

                //System.out.println(String.format("rankStartRow: %d, rankEndRow: %d, rowOffset: %d, nElements: %d",
                  //      rankStartRow, rankEndRow, rowOffset, nElements));
